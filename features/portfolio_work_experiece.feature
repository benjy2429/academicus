...
Scenario: Visit the work experience page
  ...
  Then I should be on the Work Experience page
...
Scenario: Add work experience
  ...
  And I should see "January 1, 2014 to January 1, 2015"
...
Scenario: Edit work experience
  ...
  And I should see "June 6, 2010 to December 12, 2011"

Scenario: Delete work experience
  Given I am on the Work Experience page
  And I have a Work Experience "Developer" at "Google" from "06-06-2010" to "12-12-2011"
  When I touch navbar button "Edit"
  And I touch "Delete Developer at Google, June 6, 2010 to December 12, 2011"
  And I touch "Delete"
